# Define Inception classifier here
class XceptionClassifier(tf.keras.Model):
    """
    This function defines the Inception classifier to be 
    used for both bin and multi classifiers
    """
...
# train using given hyperparameters
def train(train_dataset, valid_dataset,
    ...
    """
    This function trains the inception classifier and saves loss, accuracy and f1 plots
    """
...
def test(x_classifier, test_dataset, save_plot_fname, n_classes=3):
    """
    This function tests the inception classifier and saves confusion matrix plots
    """
...
#         print(cm)
    ...
    class_names = ['normal', 'bacterial', 'viral'] if n_classes == 3 else ['normal', 'pneumonia']
